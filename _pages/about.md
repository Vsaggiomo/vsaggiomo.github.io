...
profile:
  ...
  more_info: >
    <p>Bornse Weilanden 9</p>
    <p>Axis Y, room Y1034</p>
    <p>6708WG Wageningen, The Netherlands</p>
...
Chemist by training and a "maker" by heart. Currently based at Wageningen University & Research (WUR), my work lives at the intersection of organic chemistry, material science, and DIY technology.

My mission is the democratization of science. I believe that the high cost and the closeness of scientific instrumentation should not be a barrier to discovery. To solve this, I develop "Open Technologies": repurposing consumer electronics like 3D printers and microcontrollers into sophisticated laboratory robots and diagnostic tools. From the T-Cup (a low-cost, non-instrumental DNA detection device) to the EnderScope (an automated scanning microscope built on a 3D printer frame), my research proves that cutting-edge science can be affordable, open, transparent, and reproducible.
