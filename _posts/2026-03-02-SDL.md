...
# Bridging the Lab Digital Divide: Why We Must Democratize Self-Driving Labs
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/blog/DemSDL.png" title="old time" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
**Open science is the only way forward. The question is: Are you coming along for this fight? Or Did you exchange A walk-on part in the war for a lead role in a cage?**
